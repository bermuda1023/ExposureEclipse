 ...
 * the raw values plus a clear source attribution so the underwriter can
 * trace the number on the map back to the publishing agency.
 *
 * Mounts bottom-left of the map container; only renders when a peril is
 * active.
 */
